...
def calculate_demographic_data(print_data=True):
    ...
    new_df = round((df[(df["salary"] == ">50K")]["native-country"].value_counts()/df["native-country"].value_counts())*100, 1)
    new_df =  new_df.sort_values(ascending=False)
    highest_earning_country = new_df.index[0]
    highest_earning_country_percentage = new_df[0]
